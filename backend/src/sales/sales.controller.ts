...
export class SalesController {
  ...
  // Customer full statement (all invoices + payments)
  ...
  getCustomerStatement(
    ...
    return this.salesService.getCustomerStatement(customerId, startDate, endDate);
  }

  // ✅ NEW: Get all customers endpoint
  @Get('customers')
  getAllCustomers() {
    return this.salesService.getAllCustomersWithDebt();
  }
