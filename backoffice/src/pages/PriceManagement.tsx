    ...
    const handlePreviewMargins = async () => {
        ...
        try {
            ...
            const preview = productsData.map((p: any) => {
                // Respect product's costMethod: LAST_PRICE uses cost, COST_AVG uses costAvg
                const baseCost = p.costMethod === 'LAST_PRICE'
                    ? Number(p.cost || 0)
                    : Number(p.costAvg || 0);
                return {
                    id: p.id,
                                    ...
                                    <table style={{ width: '100%', fontSize: '13px', borderCollapse: 'collapse' }}>
                                        <thead>
                                            <tr style={{ background: '#f9fafb', borderBottom: '2px solid #e5e7eb' }}>
                                                ...
                                                <th style={{ padding: '12px', textAlign: 'center', fontWeight: '700' }}>طريقة التكلفة</th>
                                                <th style={{ padding: '12px', textAlign: 'center', fontWeight: '700' }}>التكلفة المعتمدة</th>
                                                    ...
                                                    <tr key={p.id} style={{ borderBottom: '1px solid #f3f4f6' }}>
                                                        ...
                                                        <td style={{ padding: '12px', textAlign: 'center' }}>
                                                            <span style={{
                                                                ...
                                                                fontSize: '11px',
                                                                fontWeight: '600',
                                                                background: p.costMethod === 'LAST_PRICE' ? '#fef3c7' : '#dbeafe',
                                                                color: p.costMethod === 'LAST_PRICE' ? '#92400e' : '#1e40af',
                                                            }}>
                                                                {p.costMethod === 'LAST_PRICE' ? 'آخر شراء' : 'متوسط'}
                                                            </span>
                                                        </td>
                                                        <td style={{ padding: '12px', textAlign: 'center', color: '#6b7280', fontWeight: '600' }}>
